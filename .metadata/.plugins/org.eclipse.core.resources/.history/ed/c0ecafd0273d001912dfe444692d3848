...
class BasicsDemo {
	  ...
	  //Pass By value Mechannism  & Method overloading example 
	   ...
	   {
		   System.out.println("Value passed for i go(int i)--"+i);
		   
	   }
	   static void go(short j)
	   {
		   System.out.println("Value passed for j go(short j)--"+j);
...
public static void main(String[] args) {	
	 ...
	 /*-------------		 PassbyValue Mechanism -----------           */
		 int[] array= {1,2};
		go(array);
		 System.out.println("array[a]"+array[1]);
